...
public class PermutationsSwapIterator<T extends Object> implements Iterator<Swap<T>> {

	/**
	 * After http://www.cut-the-knot.org/Curriculum/Combinatorics/JohnsonTrotter.shtml
	 * 
	 */
	...
	public Swap<T> next() {
		...
		Swap<T> swap = new Swap<T>(values[references[chosenIndex].reference], values[references[neighbourIndex].reference]);
